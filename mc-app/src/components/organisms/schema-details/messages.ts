...
export default defineMessages({
  ...
  targetProductTypesTitle: {
    id: 'Container.form.targetProductTypes.title',
    description: 'This is the title for the target product types field',
    defaultMessage: 'Target Product Types',
  },
  addProductTypeButton: {
    id: 'Container.form.addProductType.button',
    description: 'This is the label for the add product type button',
    defaultMessage: 'Add Product Type',
  },
  attributeTitle: {
    id: 'Container.form.attribute.title',
    description: 'This is the label for the attribute field',
    defaultMessage: 'product-type Attribute',
  },
  productTypeTitle: {
